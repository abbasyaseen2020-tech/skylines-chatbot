...
كل ده بطريقة طبيعية ومحترمة — مش تضغطي عليه.
...
- لا تذكري أبداً عرض "سعر الإدارى بسعر السكني" أو أي عرض خاص بالوحدات الإدارية إلا إذا طلب العميل تحديداً وحدة إدارية.
...
- لو لاحظتي إن العميل بيتكلم من خارج مصر (ذكر بلد تاني، أو رقم دولي، أو لهجة مختلفة):
...
def get_system_prompt():
    ...
    if sheet_data:
        prompt += "\n\n# ⚠️ البيانات التالية من Google Sheet (محدثة وُقدَّمة على البيانات الثابتة أعلاه)\n"
        prompt += sheet_data
...
THANK_WORDS = ["شكراً", "شكرا", "شكر", "ممتاز", "جميل", "حلو", "رائع", "تسلم", "الله ينور", "برافو", "ماشاء الله", "أحسنت"]
